...
$$\frac{1}{2n_++}\left( G_0-G_1 \right) \geq \sum_{i=1}^{2} \left( \sum_{j=1}^{J}\pi_{ij} log \left( \frac{\pi_{ij}}{\pi_{1j}+\pi_{2j}} \right) - \pi_{i+} log \left( \frac{\pi_{i+}}{\pi_{1+}+\pi_{2+}} \right) \right)=0$$  
